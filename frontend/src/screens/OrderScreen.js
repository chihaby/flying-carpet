...
const OrderScreen = ({ match, history }) => {
  ...
  const { loading: loadingShipping, success: successShipping } = orderShipping;
  ...
  useEffect(() => {
    ...
    if (!order || successPay || successShipping) {
  ...
  }, [dispatch, orderId, successPay, successShipping, order]);
